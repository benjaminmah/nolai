...
input_file_path = 'ima.txt'  # Update this path
output_file_path = 'ima.txt'  # Update this path if you want to write to a new file, or use input_file_path to overwrite
