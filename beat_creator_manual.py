...
if __name__ == "__main__":
    ...
    input_file_path = 'assets/afterlike.txt'  # Update this path
    output_file_path = 'assets/afterlike.txt'  # Update this path if you want to write to a new file, or use input_file_path to overwrite
